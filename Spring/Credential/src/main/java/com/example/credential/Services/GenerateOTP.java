...
public class GenerateOTP {
    ...
    public int sendVerificationEmail(String reg,String name)  throws MessagingException, UnsupportedEncodingException {
        Random rnd = new Random();
        randomCode = rnd.nextInt(999999);
        String content = "<div style='align:center'>Dear "+ name + ",<br>"
